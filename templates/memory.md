<!-- factory:template - delete this line once you have filled this in -->
# Factory memory
...
- the integration suite needs redis running, agy cannot start it, run it yourself first
- ADR-0002 bans new global state; two runs tried it anyway, call it out in the handoff
-->
